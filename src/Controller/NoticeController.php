...
class NoticeController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        $statusId = (int) ($this->isGranted('ROLE_ADMIN') ? NoticeStatus::STATUS_ACTIVE->value : $request->query->get('statusId', NoticeStatus::STATUS_ACTIVE->value));
    ...
    public function edit(Request $request, Notice $notice): Response
    {
        ...
        return $this->render('notice/edit.html.twig', [
            'form' => $form->createView(),
            'notice' => $notice,  // Przekazujemy obiekt notice, który zawiera kategorię
        ]);
    }
